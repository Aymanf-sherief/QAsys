...
public class SearchFiles {
    ...
    public static Vector<String> Find(String queryString) throws Exception {
        ...
        while (true) {
            ...
            result = doPagingSearch(in, searcher, query, hitsPerPage, raw, queries == null && queryString == null);
     ...
     *
     */
    public static Vector<String> doPagingSearch(BufferedReader in, IndexSearcher searcher, Query query,
