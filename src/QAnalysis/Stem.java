...
readInStaticFiles();
    ...
    private void stemText ( String Text )
    {
        ...
        String currentWord;
        // tokenize each line
        tokenizedLine = new Vector(Arrays.asList(Text.split(" ")));
 ...
 // read in the contents of a file, put it into a vector, and add that vector
    ...
    public Vector getStemsAsVector () {
        return stemmedText;
    }
}